...
export class AppState {
    ...
    private swarmyRobotType = new RobotType('l_swarmy', 'Leaphy Swarmy', 'orig.svg', 'ESP32 Dev Module', 'esp32:esp32:esp32', 'bin', 'esp32:esp32', [], true, true, ['https://dl.espressif.com/dl/package_esp32_index.json']);
